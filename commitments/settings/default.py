"""
Django settings for commitments project.
...
SECRET_KEY = 'ia)5hktid)0mu@tn(ap$*o+e4!lpl2o^*z0^8gm&jpb94*wg_n'
...
WSGI_APPLICATION = 'commitments.wsgi.application'
